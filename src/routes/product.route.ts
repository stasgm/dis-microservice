...
export class ProductRoute {
  ...
  private routes(): void {
     ...
     */
    this.api.get('/', this.productController.findAllProductCode.bind(this.productController));
     ...
     *   get:
     *     tags: ["Product"]
     *     summary: Returns a product for a given productCode
     *     security:
     *      - bearerAuth: []
     *     parameters:
     *      - in: path
     ...
     *         description: Error during query execution
     */
    this.api.get('/:productCode', this.productController.findOneByProductCode.bind(this.productController));
  }
}
